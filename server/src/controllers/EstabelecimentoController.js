...
class EstabelecimentoController {
  async criarEstabelecimento(req, res) {
    const Estabelecimento = await EstabelecimentoService.criarEstabelecimento(
      req
    );
  ...
  async buscarEstabelecimento(req, res) {
    const Estabelecimento = await EstabelecimentoService.buscarEstabelecimento(
      req
    );
    return res.status(Estabelecimento.status).json(Estabelecimento);
  }
  ...
  async editarEstabelecimento(req, res) {
    const Estabelecimento = await EstabelecimentoService.editarEstabelecimento(
      req
    );
    return res.status(Estabelecimento.status).json(Estabelecimento);
  }
  ...
  async excluirEstabelecimento(req, res) {
    const Estabelecimento = await EstabelecimentoService.excluirEstabelecimento(
      req
    );
    return res.status(Estabelecimento.status).json(Estabelecimento);
  }
